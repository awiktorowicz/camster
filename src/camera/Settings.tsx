...
const Settings = () => {
  ...
  const [documentWidthValue, setDocumentWidthValue] = useState(
    DocPresets.passport.documentWidth,
  );
  const [documentHeightValue, setDocumentHeightValue] = useState(
    DocPresets.passport.documentHeight,
  );
    ...
    setGlobalData({
      autoCapture: {
        config: {
          ...
          debug: {
            isSelected: debugChecked,
            isShowingDetectedContour: true,
            isShowingDetectedGlare: true,
          },
        },
      },
    });
    ...
    <div>
      ...
      <div>
        ...
        <input
          ...
          min="1"
          max="100"
          value={documentWidthValue}
          onChange={(e) => setDocumentWidthValue(parseInt(e.target.value, 10))}
        />
        %
      </div>
      ...
      <div>
        ...
        <input
          ...
          min="1"
          max="100"
          value={documentHeightValue}
          onChange={(e) => setDocumentHeightValue(parseInt(e.target.value, 10))}
        />
        %
      </div>
